...
def main(params):
    # Check whether the parameter exist null
    ...
    # Setup logging
    # #
    # Set the dict about <k,v> = <parameter, type>  type = <int, float, int, str>
    ...
    # test part is needed
    # load the load_model from the param['load_model']
...
def add_common_parser_opts(parser):
    ...
    # beta_schedule decide to how stochastic the policy
    ...
    # decide the difference of the old and the new policy
