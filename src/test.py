...
def main(params):
    ...
    if params['sarsa_enable']:
        ...
        for i in range(num_episodes):
            ...
            values = p.run_test(compute_bounds=params['compute_kl_cert'], use_full_backward=params['use_full_backward'], original_stdev=original_stdev)
            ep_length, ep_reward, actions, action_means, states, kl_certificates = values
